...
<header>
    <div class="menu-left">
      <button id="help-button" class="icon" aria-label="Help" tabindex="-1">
        <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" on:click={() => dispatch('launchwelcomeModal')}>
    ...
    <h1 class="title">Katlo</h1>
    <div class="menu-right">
      <button id="statistics-button" class="icon" aria-label="Statistics" tabindex="-1">
        <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" on:click={() => dispatch('launchwinModal')}>
      ...
      <button id="settings-button" class="icon" aria-label="Settings" tabindex="-1">
        <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" on:click={() => dispatch('overlay')}>
